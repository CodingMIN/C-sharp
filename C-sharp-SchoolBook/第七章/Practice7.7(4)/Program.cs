...
namespace Practice7._7_4_
{
    class Stock
    {
        ...
        { StockName = stockName; StockPrice = price; }
        ...
        public void PriceDown(double down)
        {
            ...
            PriceDownEvent(down); StockPrice -= down;
        }
    }
    ...
    class Buyer
    {
        ...
        public Buyer(Stock stock) { this.stock = stock; }
    }
    ...
    class Seller
    {
        ...
        public void StockPriceRise(double up)
        {
            ...
            else { Console.WriteLine("股票正小幅上涨，卖家请继续观望"); }
        }
        public void StockPriceDown(double down)
        {
            if (down / stock.StockPrice >= 0.05)
            { Console.WriteLine("股票下跌已经超过5%，卖家请逢低补仓"); }
            else { Console.WriteLine("股票正小幅下跌，卖家请谨慎操作"); }
        }
        public Seller(Stock stock) { this.stock = stock; }
    }
